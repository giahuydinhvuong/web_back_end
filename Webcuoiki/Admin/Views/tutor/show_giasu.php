...
<body>
            ...
            <h3 class="display-3" style="text-align: center;">Danh sách gia sư cần phê duyệt</h3>
     ...
     <div class="chua">
        ...
        ?>
              <div class="column">
                ...
                <div >              
                        	<small><a  href="?controller=admin&action=accept&id=<?php echo $value['id'] ?>" class="btn btn-success" name="accept">Xem  <i  class="fa fa-pencil"></i></a></small>						
