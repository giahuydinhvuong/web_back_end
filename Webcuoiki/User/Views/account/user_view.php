   ...
   <link rel="stylesheet" href="../">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Caveat&display=swap" rel="stylesheet">
     <link rel="stylesheet" type="text/css" href="../../../User/Public/css/bootstrap.min.css">
        ...
        <link rel="stylesheet" type="text/css" href="../User/Public/css/TrangChu.css">
    ...
    <link rel="stylesheet" href="User/Public/css/user_vew.php">
    <style >
    ...
    <div class="den">
        <div class="cot">
            ...
            <div class="menu">
                ...
                <ul>
                    <li><a href="?act=home">Nhà Của Tôi</a></li>
                          ...
                          <a ><i onclick="hamDropdown()" class="nut_dropdown fas fa-user-circle"></i></a>
			                      <div class="noidung_dropdown">
			                        <table style="margin:5px;">
			    	                    ...
			    	                    <tr>
			    		                    <td><a href = '?controller=view_user&action=account'>Tài khoản</a></td>
			    	                    </tr>
			    	                    <tr>
